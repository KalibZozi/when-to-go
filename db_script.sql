...
CREATE TABLE `where_to_go`.`routes` ( `agency_id` VARCHAR(50) NULL , `route_id` VARCHAR(50) NOT NULL , `route_short_name` VARCHAR(10) NOT NULL , `route_long_name` VARCHAR(100) NULL , `route_type` INT NULL , `route_desc` VARCHAR(100) NOT NULL , `route_color` VARCHAR(6) NULL , `route_text_color` VARCHAR(6) NULL , PRIMARY KEY (`route_id`)) ENGINE = MyISAM;

CREATE TABLE `where_to_go`.`trips` ( `route_id` VARCHAR(50) NOT NULL , `trip_id` VARCHAR(50) NOT NULL , `service_id` VARCHAR(50) NULL , `trip_headsign` VARCHAR(50) NULL , `direction_id` INT NULL , `block_id` VARCHAR(50) NULL , `shape_id` VARCHAR(10) NULL , `wheelchair_accessible` INT NULL , `bikes_allowed` INT NULL , `boarding_door` INT NULL , PRIMARY KEY (`trip_id`), INDEX `idx_trips_route_id` (`route_id`)) ENGINE = MyISAM;
