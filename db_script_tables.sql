...
--
-- Gép: 127.0.0.1:3306
-- Létrehozás ideje: 2019. Ápr 03. 00:12
...
CREATE TABLE IF NOT EXISTS `routes` (
  ...
  PRIMARY KEY (`route_id`,`data_version`) USING BTREE
...
CREATE TABLE IF NOT EXISTS `stops` (
  ...
  `data_version` int(11) NOT NULL DEFAULT '1',
  PRIMARY KEY (`stop_id`,`data_version`) USING BTREE,
...
CREATE TABLE IF NOT EXISTS `trips` (
  ...
  `data_version` int(11) NOT NULL DEFAULT '1',
  PRIMARY KEY (`trip_id`,`data_version`) USING BTREE,
